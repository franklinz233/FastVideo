#!/bin/bash
# Preprocess SpatialVID-HQ dataset for Wan 2.1 1.3B training: 321 frames @ 16 FPS (~20s clips)
# num_latent_t = (321 - 1) / 4 + 1 = 81

GPU_NUM=8
MODEL_PATH="Wan-AI/Wan2.1-T2V-1.3B-Diffusers"
DATASET_PATH="/root/data_root/dataset/SpatialVID-HQ/formatted-321f/"
OUTPUT_DIR="/root/data_root/dataset/SpatialVID-HQ/processed-321f/"
